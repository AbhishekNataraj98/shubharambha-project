...
const styles = StyleSheet.create({
  ...
  stepCircleActive: { backgroundColor: '#D85A30' },
  ...
  stepLabelActive: { marginTop: 4, fontSize: 11, color: '#D85A30', fontWeight: '600' },
  ...
  amountPrefix: { fontSize: 20, color: '#D85A30', fontWeight: '700' },
  ...
  pillActive: { backgroundColor: '#D85A30' },
  pillInactive: { backgroundColor: '#F2EDE8' },
  ...
  resetLink: { marginTop: 8, fontSize: 12, color: '#D85A30', fontWeight: '600' },
  footer: {
    borderTopWidth: 1,
  ...
  pickerWrap: { backgroundColor: '#FFFFFF', borderTopWidth: 1, borderTopColor: '#F2EDE8' },
  pickerDone: {
    alignSelf: 'flex-end',
    minHeight: 42,
    justifyContent: 'center',
  ...
  pickerDoneText: { color: '#D85A30', fontWeight: '700' },
  datePicker: {
    backgroundColor: '#FFFFFF',
  },
})
