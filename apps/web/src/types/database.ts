  ...
  public: {
    Tables: {
      ...
      material_price_updates: {
        Row: {
          cement_rate: number | null
          id: string
          project_id: string
          recorded_at: string | null
          recorded_by: string | null
          steel_rate: number | null
        }
        Insert: {
          cement_rate?: number | null
          id?: string
        ...
        Relationships: [
          {
            foreignKeyName: "material_price_updates_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "projects"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "material_price_updates_recorded_by_fkey"
            columns: ["recorded_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      project_financials: {
        Row: {
          agreed_cement_rate: number | null
          agreed_steel_rate: number | null
          built_up_area_sqft: number
          category_budget: Json | null
          created_at: string | null
